...
<script type="text/javascript">
	export default {
		...
		methods: {
			...
			{
				let id = this.$route.params.id;
				axios.patch('/inventoryWithVueAndAPI/public/api/product/'+id,this.form)
				.then(response => {
		...
		created()
		{
			...
			axios.get('/inventoryWithVueAndAPI/public/api/category')
			.then(response => {
				this.categories = response.data;
			})

			//Suppliers Collected
			axios.get('/inventoryWithVueAndAPI/public/api/supplier')
			.then(response => {
